...
3. **Navigate the Command Line**
    ...
    - View and understand FASTQ files (`zcat`, wildcards)

5. **Understand the setup of an HPC**
...
7. **Analyse long-read data**
    - Perform quality control
    - Align quality-filtered reads to reference database 
