...
quarto render --profile standalone source/cli.qmd
quarto render --profile standalone source/hpc_intro.qmd
quarto render --profile standalone source/hpc_howto.qmd
quarto render --profile standalone source/applied_workflow.qmd

cd slides 
quarto render

# Render main doc (if needed)
cd ..
quarto render

quarto render .\source\miceco2025_analysis.qmd --execute-dir .
```
