...
Below is a template for a script that you should store in the file `scripts/nanoplot.sh`.  Replace all `...` with the correct code.
...
Your task is now to use Nanoplot and use the right options (check the manual for those) and:
