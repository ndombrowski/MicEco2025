...
- Exercise for `srun`: Let student analyse the nanopore data with seqkit
- Exercise with `sbatch`: Let student analyse the nanopore data with nanoplot to build up the challenge but need to give enough code snippet so they do not get stuck
