...
# Blatula VII, Stapylococcus, Anaerostipes, Limosilactobacillus
...
# Define data paths
input_folder = Path("../analyse_practical_data/results/mapping_counts/")
taxon_path = Path("data/accession_to_genus.tsv")
stats_path = Path("data_analysis/results/seqkit/seqkit_chopper.tsv")
